...
public:
    ...
    /**
      * @brief Retrieves the size of each of the dimensions if the buffer
      *        were to be interpreted as a multi-dimensional array.
      *
      * @return Size of each dimension, in number of elements.
     */
